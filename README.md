...
<img src="images/domain_controller.png" alt="domain controller screenshot" width=600/>

Install Windows Server ISO on the Domain Controller
<img src="images/windows_server_installation.png" alt="windows server installation" width=600/> 

Install Active Directory
<img src="images/install_active_directory.png" alt="active directory installation" width=600/>

Create Domain named `cyberjour`
<img src=-"images/create_domain.png" alt="domain creation" width=600/> 

Create Admin User
<img src="images/create_admin_user.png" alt="admin user creation" width=600/>

Add created admin user to domain admins
<img src="images/add_user_to_domain_admins.png" alt="add user to domain admins" width=600/>

Install Remote Access
<img src="images/install_remote_access.png" alt="install remote access" width=600/>

Configure Remote Access
<img src="images/configure_remote_access.png" alt="configure remote access" width=600/>

Install DHCP Server
<img src="images/install_dhcp_server.png" alt="install dhcp server" width=600/>

Setup and authorize DHCP
<img src="images/setup_and_authorize_dhcp.png" alt="dhcp setup" width=600/>
